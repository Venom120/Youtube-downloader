...
class SearchController:
    ...
    def search_videos(
        ...
        Args:
            ...
            callback: Called with SearchResult when complete
            error_callback: Called if search fails
        """
        def search_thread():
            try:
    ...
    def get_video_info(
        ...
        Args:
            ...
            callback: Called with VideoInfo when complete
            error_callback: Called if retrieval fails
        """
        def info_thread():
            try:
    ...
    def get_playlist_videos(
        ...
        Args:
            ...
            callback: Called with list of VideoInfo when complete
            error_callback: Called if retrieval fails
        """
        def playlist_thread():
            try:
